...
export interface LogoProps {
  ...
  logoOnly?: boolean;
  /**
   * Additional class names for the brand name text.
   */
...
export function LogoIcon({ width = 22, height = 27, className }: LogoIconProps) {
  return (
    <svg
      width={width}
      height={height}
...
export function Logo({
  ...
  return (
    <div className={cn("flex items-center gap-2.5", className)}>
      ...
      {brandName && (
        <span className={cn("font-bold tracking-tight text-inherit", brandNameClassName)}>
