...
import { getColorClassName, type AvailableChartColorsKeys } from "@/lib/chart-utils";
          ...
          >
            <div
              className={cn(
                ...
                onValueChange ? "group-hover:opacity-80" : "",
                // margin and duration
                {
                ...
                {item.href ? (
                  <a
                    ...
                    className={cn(
                      ...
                      // text color
                      getColorClassName(color, "foreground"),
                      // hover
        ...
        {sortedData.map((item, index) => (
          ...
          >
            <p
              className={cn(
                // base
                "truncate whitespace-nowrap text-sm leading-none text-foreground",
                // text color
                // text color
