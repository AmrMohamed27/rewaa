        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip
              ...
              content={({ active, payload, label: givenLabel }) => {
                const cleanPayload: TooltipProps["payload"] = payload
                  ...
                  : [];
                const label = givenLabel?.toString();
                if (!label) {
                  return null;
                }
...
export { ComboChart, type ComboChartEventProps, type TooltipProps, type ComboChartProps };
