          ...
          linkedExam: {
            ...
            examContent: {
              ...
              questions: [
                {
                  id: "q-001",
                  questionText: "What is the SI unit for electric current intensity?",
                  options: [
                    { id: "opt-1", text: "Ampere" },
                    { id: "opt-2", text: "Volt" },
                    { id: "opt-3", text: "Ohm" },
                    { id: "opt-4", text: "Coulomb" },
                  ],
                  correctAnswer: "opt-1",
                  grade: 10,
                  explanation: "The Ampere is the SI unit measuring Coulombs per second.",
                },
              ],
            },
          },
